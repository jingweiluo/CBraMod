...
from utils.util import generate_mask, random_masking
...
class Trainer(object):
    def __init__(self, params, data_loader, model):
        ...
        # if macs is None:
        #     print("Computational complexity: N/A (FLOPs estimation failed)")
        # else:
        #     print('{:<30}  {:<8}'.format('Computational complexity: ', macs))

        # if params is None:
        #     print("Number of parameters:   N/A")
        # else:
        #     print('{:<30}  {:<8}'.format('Number of parameters: ', params))
        ...
        for epoch in range(self.params.epochs):
            ...
            for x in tqdm(self.data_loader, mininterval=10):
                ...
                if self.params.need_mask:
                    ...
                    # # Model_B
                    # loss, pred, mask = self.model(x, self.params.mask_ratio)
            ...
            if  mean_loss < best_loss:
                model_path = rf'{self.params.foundation_dir}/epoch{epoch+1}_loss{mean_loss}.pth'
